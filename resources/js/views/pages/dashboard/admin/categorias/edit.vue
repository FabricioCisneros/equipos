            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 px-5">
                <div class="md:flex md:items-center md:justify-between">
                    ...
                    <div class="mt-4 flex md:mt-0 md:ml-4">
                        <button class="btn btn-red shadow-sm rounded-md" type="button" @click="deleteLabelModal = true">
                            {{ $t('Borrar categoria') }}
                        </button>
                    </div>
                </div>
        ...
        <div v-show="deleteLabelModal" class="fixed z-20 inset-0 overflow-y-auto">
            <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
                ...
                <transition enter-active-class="ease-out duration-300"
                    ...
                    <div v-show="deleteLabelModal" aria-labelledby="modal-headline" aria-modal="true"
                                ...
                                <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                                    ...
                                    <div class="mt-2">
                                        <p class="text-sm leading-5 text-gray-500">
                                            ...
                                            {{ $t('Toda la informacion relacionada con esta etiqueta sera eliminada') }}.
                        ...
                        <div class="bg-gray-100 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                            ...
                            <button class="btn btn-white mr-0 sm:mr-2" type="button" @click="deleteLabelModal = false">
                                {{ $t('Cancelar') }}
                            </button>
                        </div>
                    </div>
...
export default {
    ...
    metaInfo() {
        return {
            title: this.$i18n.t('Modificacion de etiquetas')
        }
    },
    data() {
        return {
