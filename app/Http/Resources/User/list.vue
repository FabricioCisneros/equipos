        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 px-5">
            <div class="md:flex md:items-center md:justify-between">
                <div class="flex-1 min-w-0">
                    <h1 class="py-0.5 text-2xl font-semibold text-gray-900">{{ $t('usuarios') }}</h1>
                </div>
                        ...
                        <div class="flex rounded-md shadow-sm">
                            ...
                            <span class="relative inline-flex shadow-sm rounded-r-md">
                                ...
                                >
                                    ...
                                    <option value="">{{ $t('username') }}</option>
                                    <option value="role_id">{{ $t('Area') }}</option>
                                    <option value="status">{{ $t('status de usuario') }}</option>
                                            ...
                                            <div class="min-w-0 flex-1 px-4 lg:grid lg:grid-cols-2 lg:gap-4">
                                                ...
                                                <div class="hidden lg:block">
                                                    ...
                                                    >
                                                        ...
                                                        {{ $t('El usuario esta deshabilitado') }}
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
