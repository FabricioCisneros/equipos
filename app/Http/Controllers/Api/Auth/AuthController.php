...
class AuthController extends Controller
{
    ...
    public function login(LoginRequest $request): JsonResponse
    {
        ...
        return response()->json(['message' => __('Las credenciales estan incorrectas o el usuario esta deshabilitado')], 406);
    }
    ...
    public function logout(): JsonResponse
    {
        ...
        return response()->json(['message' => __('La sesion se cerró satisfactoriamente')]);
    }
